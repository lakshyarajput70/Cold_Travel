...
export default function Destinations() {
  ...
  return (
    <View className="flex-row mx-4 justify-between flex-wrap">
...
const DestinationCard = ({ item , navigation }) => {
  ...
  return (
    <TouchableOpacity onPress={()=>navigation.navigate("DestinationScreen",{...item})} style={{ width: wp(44), height: wp(65) }} className="flex justify-end relative p-4 py-6 space-y-2 mb-5">
